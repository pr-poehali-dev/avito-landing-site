  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50">
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-l from-purple-200 to-transparent rounded-full blur-3xl opacity-30 animate-float"></div>
      </section>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 bg-gradient-to-br from-white to-purple-50/50">
                <CardHeader className="text-center">
                  <div className="mx-auto w-16 h-16 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            {portfolio.map((project, index) => (
              <Card key={index} className="text-center hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-white to-gray-50">
                <CardContent className="pt-8">
                  <div className="text-3xl font-bold text-purple-600 mb-2">{project.result}</div>
